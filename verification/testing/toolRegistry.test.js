...
test('the registry has exactly the 21 required tools, in the requested order', () => {
...
test('business_configuration_retrieval, product_data_retrieval, market_research, customer_research, competitor_research, keyword_research, seo_analysis, listing_content_generation, marketing_analysis, social_content_planning, paid_advertising_planning, social_media_strategy_generation, platform_content_generation, content_calendar_generation, advertising_strategy_planning, advertising_performance_analysis, and ai_reasoning_completion are implemented', () => {
